...
IL_0020:
	{
		int32_t L_6 = V_0;
		if ((!(((uint32_t)((int32_t)il2cpp_codegen_subtract((int32_t)L_6, ((int32_t)18)))) > ((uint32_t)2))))
		{
			goto IL_0053;
		}
	}
...
IL_0030:
	...
	{
		int32_t L_9 = V_0;
		if ((!(((uint32_t)((int32_t)il2cpp_codegen_subtract((int32_t)L_9, ((int32_t)31)))) > ((uint32_t)1))))
		{
			goto IL_0053;
		}
	}
...
IL_0053:
	{
		bool* L_13 = (bool*)(&__this->___m_HideSoftKeyboard);
		bool L_14 = ___0_value;
		bool L_15;
		L_15 = SetPropertyUtility_SetStruct_TisBoolean_t09A6377A54BE2F9E6985A8149F19234FD7DDFE22_mFC5853627DE5D7B57CA91271BE9B87C37468C5B0(L_13, L_14, SetPropertyUtility_SetStruct_TisBoolean_t09A6377A54BE2F9E6985A8149F19234FD7DDFE22_mFC5853627DE5D7B57CA91271BE9B87C37468C5B0_RuntimeMethod_var);
		goto IL_006b;
	}
...
IL_006b:
	{
		bool L_16 = __this->___m_HideSoftKeyboard;
		if (!L_16)
		{
			goto IL_008f;
		}
	...
	{
		bool L_18;
		L_18 = TouchScreenKeyboard_get_isSupported_mCFAC95CA6CAA06B4E21F42E3C40A39668D6B438E(NULL);
		if (!L_18)
		{
			goto IL_008f;
		}
	}
	{
		...
		NullCheck(L_19);
		bool L_20;
		L_20 = TouchScreenKeyboard_get_active_mB22402FB9E56D3F652DA785F01E504A530FF8775(L_19, NULL);
...
IL_0090:
	...
	{
		TouchScreenKeyboard_tE87B78A3DAED69816B44C99270A734682E093E7A* L_22 = __this->___m_SoftKeyboard;
		NullCheck(L_22);
		TouchScreenKeyboard_set_active_m4382D57F87E4C86B59864E86BE93A8A2A474B7C2(L_22, (bool)0, NULL);
...
IL_00b2:
	{
		...
		L_27 = VirtualFuncInvoker0< NumberFormatInfo_t8E26808B202927FEBF9064FCFEEA4D6E076E6472* >::Invoke(20, L_26);
		NullCheck(L_27);
		String_t* L_28;
